from utilities2 import parse, parse_and_interpolate
...
def get_fft_features(data1):
	...
	feature3 = [ abs(list(tsfresh.feature_extraction.feature_calculators.fft_coefficient(data1[i,:], [{"coeff": 4, "attr": "real"}]))[0][1]) for i in range(len(data1)) ]
	feature4 = [ abs(list(tsfresh.feature_extraction.feature_calculators.fft_coefficient(data1[i,:], [{"coeff": 5, "attr": "real"}]))[0][1]) for i in range(len(data1)) ]
	feature5 = [ abs(list(tsfresh.feature_extraction.feature_calculators.fft_coefficient(data1[i,:], [{"coeff": 6, "attr": "real"}]))[0][1]) for i in range(len(data1)) ]
